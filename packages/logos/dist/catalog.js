...
exports.listLogoCatalog = listLogoCatalog;
exports.getLogoByDomain = getLogoByDomain;
exports.searchLogoCatalog = searchLogoCatalog;
const seedLogos = [
...
const catalog = seedLogos.map((logo) => ({
...
function searchLogoCatalog(query, limit = 120) {
