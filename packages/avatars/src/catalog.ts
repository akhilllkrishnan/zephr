...
const avatarStyles: AvatarStyleDefinition[] = [
  {
    id: "initials",
    label: "Initials",
...
export function listAvatarStyles(): AvatarStyleDefinition[] {
  return [...avatarStyles];
}

export function getAvatarStyle(style: AvatarStyle): AvatarStyleDefinition {
  return styleById.get(style) ?? avatarStyles[0];
}

export function searchAvatarStyles(query: string, limit = 10): AvatarStyleDefinition[] {
